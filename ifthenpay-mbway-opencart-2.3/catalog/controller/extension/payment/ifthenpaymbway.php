...
class ControllerExtensionPaymentifthenpayMbway extends Controller {
    ...
    public function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/ifthenpaymbway.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/extension/payment/ifthenpaymbway.tpl', $data);
        } else {
            return $this->load->view('extension/payment/ifthenpaymbway.tpl', $data);
        }
    }
