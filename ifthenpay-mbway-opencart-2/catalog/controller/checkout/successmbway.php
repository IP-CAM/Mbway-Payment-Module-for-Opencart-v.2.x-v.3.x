<?php
class ControllerCheckoutSuccessMbWay extends Controller {
	public function index() {
        ...
        if (isset($this->session->data['order_id'])) {
			...
			$mbway_table = "<b>Pagamento MBWAY:</b> <br/>" . $this->session->data['payment_method']['comment'];
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('checkout/successmbway')
		);
